...
- Visualise sales statistics
- Present total sales
- Highlight which roast types and coffee types produce the most sales
- Which countries generate the most sales
- Which coffee size is most often purchased  
...
- 0.5kg coffee size is most purchased, the US produces the most revenue  
- Light coffee is most desired  
- The most popular coffee type is Excelsa whilst the least popular is Robusta  
...
## Dashboard Preview
![Coffee Sales Dashboard](Assets/Coffee-Sales-Dashboard.PNG)
